$(document).ready(function() {
  ...
  $("#o").click(function() {
    ...
    ai = "X";
    start.play();
    document.getElementById("image_avatar").src="hero.jpg";
    document.getElementById("image_avatar").style.height="150px";
    document.getElementById("image_avatar").style.width="100px";
    $("#choice").fadeOut();
    $("#board").fadeTo("slow",1);
  });
  ...
  //clears the board
  function clearBoard() {
    document.getElementById("image_avatar").src="a.gif";
    document.getElementById("image_avatar").style.height="400px";
    document.getElementById("image_avatar").style.width="450px";
    again.play()
    c00 = $("#c00").text("");
    c01 = $("#c01").text("");
    c02 = $("#c02").text("");
  ...
  function aiMove() {
    ...
    if (c00 === "" && ((c01 === ai && c02 === ai) || (c10 === ai && c20 === ai) || (c11 === ai && c22 === ai))) {
      $("#c00").text(ai);
      document.getElementById("image_avatar").src="0.png";
      document.getElementById("image_avatar").style.height="150px";
      document.getElementById("image_avatar").style.width="100px";
      audio0.play();
      turn = 0;
      ...
      $("#c01").text(ai);
      document.getElementById("image_avatar").src="1.png";
      document.getElementById("image_avatar").style.height="150px";
      document.getElementById("image_avatar").style.width="100px";
      audio1.play();
      turn = 0;
      ...
      $("#c02").text(ai);
      document.getElementById("image_avatar").src="2.png";
      document.getElementById("image_avatar").style.height="150px";
      document.getElementById("image_avatar").style.width="100px";
      audio2.play();
      turn = 0;
      ...
      $("#c10").text(ai);
      document.getElementById("image_avatar").src="3.png";
      document.getElementById("image_avatar").style.height="150px";
      document.getElementById("image_avatar").style.width="100px";
      audio3.play();
      turn = 0;
